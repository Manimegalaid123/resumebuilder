...
const templateOptions = [
  ...
  { id: 'professional', name: 'Professional', style: 'clean-modern' },
  { id: 'academic', name: 'Academic', style: 'classic-serif' },
];
            ...
            <div className="bg-card border border-border rounded-xl overflow-hidden">
              ...
              <div className="p-4 space-y-4">
                {resumeData.publications?.map((pub) => (
                  <div key={pub.id} className="p-4 bg-muted/30 rounded-lg space-y-4">
                    <div className="flex justify-between items-start">
                      <div className="grid grid-cols-2 gap-4 flex-1">
                        <div className="col-span-2">
                          <Label>Title</Label>
            ...
            <div className="bg-card border border-border rounded-xl overflow-hidden">
              ...
              <div className="p-4 space-y-4">
                {resumeData.certifications?.map((cert) => (
                  <div key={cert.id} className="p-4 bg-muted/30 rounded-lg space-y-4">
                    <div className="flex justify-between items-start">
                      <div className="grid grid-cols-2 gap-4 flex-1">
                        <div>
                          <Label>Name</Label>
        ...
        <div className="w-1/2 bg-muted/30 overflow-y-auto p-8">
          <div className="max-w-[800px] mx-auto">
            ...
            >
              ...
              {selectedTemplate === 'academic' && <AcademicTemplate data={resumeData} accentColor={colorOptions.find(c => c.id === selectedColor)!} isMonochrome={isMonochrome} />}
            </div>
          </div>
        </div>
      </div>
